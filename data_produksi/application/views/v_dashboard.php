    ...
    <div class="container-fluid">
            <div class="row" style="background-color: #1F497D;">
                ...
                <div class="col mt-4">
                    ...
                    <a class="btn btn-primary" href="<?= site_url().'C_monitoring_rakit' ?>">Monitoring</a>
                    <a class="btn btn-primary" href="<?= site_url().'C_MonitoringSpk' ?>">Daftar SPK</a>
                ...
                <div class="col-3 mt-4">
                    ...
                    <div class="row mt-2">
                        <div class="col"><label style="color:#ffffff;">Tahun</label></div>
                            ...
                            <select class="form-select" name="tahun" id="tahun">
                                ...
                                if (empty($year)) {
                                    ...
                                    // Jika $year ada
                                    if ($year == $tahun) {
                                        // Jika $year sama dengan tahun sekarang, pilih opsi tahun sebelumnya, tahun sekarang terpilih, dan tahun-tahun berikutnya
                                        ...
                                        echo "<option value=\"" . ($tahun + 3) . "\">" . ($tahun + 3) . "</option>";
                                        echo "<option value=\"" . ($tahun + 4) . "\">" . ($tahun + 4) . "</option>";
                                    } elseif ($year < $tahun) {
                                        // Jika $year lebih kecil dari tahun sekarang, pilih $year dan tahun-tahun berikutnya
                                        ...
                                        // Jika $year lebih besar dari tahun sekarang, pilih $year saja
                                        echo "<option value=\"$year\">$year</option>";
                                    }
                                }
                                ?>
                        ...
                        <div class="row mt-2">
                            ...
                            <select class="form-select" name="periode" id="periode">
                                <?php
                                $selected = empty($kuartal) ? $periode : $kuartal;
                    ...
                    <div class="row mt-2 mb-4">
                        ...
                        <div class="col d-grid"><a type="reset" href="<?= base_url().'c_dashboard/' ?>" class="btn btn-primary">Reset Filter</a></div>  
                    </div>
                </div>
                    ...
                    <table id="datatable" class="display table-sm table border border-3" style="width: 100%;">
                        <thead class="table-primary">
                            <tr>
                                ...
                                <th align="center" width="380px" scope="col">Nama Barang</th>
                                <th align="center" scope="col">Satuan</th>
                                <th align="center" scope="col">Qty</th>
                                <th align="center" scope="col">Realisasi</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?= htmlspecialchars($item->Series, ENT_QUOTES, 'UTF-8') ?></td>
                                <td><?= htmlspecialchars($item->Barang, ENT_QUOTES, 'UTF-8') ?></td>
                                <td align="center"><?= htmlspecialchars($item->Satuan, ENT_QUOTES, 'UTF-8') ?></td>
                                <td align="center"><?= htmlspecialchars($item->Kuantitas, ENT_QUOTES, 'UTF-8') ?></td>
                                <td align="center"><?= htmlspecialchars($item->Realisasi, ENT_QUOTES, 'UTF-8') ?></td>
                                ...
                                <td>
                                    <div class="row">
                                        <div class="">
                                            ...
                                            <?php else: ?>
                                                <a href="<?= base_url('c_dashboard/aktivasi?id_mps=' . urlencode($item->ID)) ?>" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Aktivasi">
                                                    <span><i class="fas fa-wheelchair"></i></span>    
                                                <!-- <span><i class="fas fa-share-alt"></i></span> -->
                                                </a>
                                            <?php endif; ?>

                                            <?php if (in_array($item->Category, ['Komponen Rehab', 'Komponen Furniture', 'Component'])): ?>
                                                <a href="<?= base_url('c_dashboard/spk_rekap?id_mps=' . urlencode($item->ID)) ?>" class="btn btn-primary btn-sm">
                                                    <span><i class="fas fa-tools"></i></span>
                                                </a>
                                            <?php else: ?>
                                                <a href="<?= base_url('c_dashboard/spk_rakit?id_mps=' . urlencode($item->ID)) ?>" class="btn btn-primary btn-sm">
                                                    <span><i class="fas fa-tools"></i></span>
                                                </a>
                                            <?php endif; ?>
                                        </div>
                                ...
                                <td><?= htmlspecialchars($item->id_kanban, ENT_QUOTES, 'UTF-8') ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
