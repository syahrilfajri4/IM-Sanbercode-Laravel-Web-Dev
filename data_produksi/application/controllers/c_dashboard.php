...
class c_dashboard extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->data['cat'] = $cat = "";
        $data['mps'] = $this->m_inventory->getAll();
    ...
    public function inputJIP() {
        ...
        if ($validation->run()) {
            // Memanggil fungsi JIPinput() dari model m_inventory untuk menyimpan data
            $input_jip->JIPinput();
        ...
        // Mengarahkan kembali ke halaman index setelah proses selesai
    ...
    function aktivasi() {
        // Memanggil metode aktivasi_mps() dari model m_inventory untuk mengaktifkan MPS
        $this->m_inventory->aktivasi_mps();
        
        // Mengarahkan pengguna ke halaman dashboard setelah proses aktivasi selesai
        redirect('c_dashboard/index');
    }
...
///////lagi dicoba
    ...
    // function spk_rekap(){
    //     $this->data['rekap'] = $this->m_inventory->getSPK_rekap();
    //     $this->data['mps'] = $_GET['id_mps'];
    //     $this->load->view('jip_rekap', $this->data);
    // }
