...
//    {
//         // Simpan URL asal sebelum pindah ke halaman ini
...
//    }
     ...
     public function tampil_tahap($id)
     {
          ...
          // Tentukan grup atau dapatkan nomor tahap jika grup kosong
          if (!empty($grup)) {
               $g = $grup;
          } else {
               $g = $this->M_master_barang->get_no_tahap();
          ...
          // Simpan grup dan lakukan operasi lainnya
          $this->M_master_barang->insert_grup($g);
          $this->session->set_flashdata('grup', $g);
